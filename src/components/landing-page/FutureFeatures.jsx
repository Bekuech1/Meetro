...
const FutureFeatures = () => {
  return (
    <div className="bg-[#F3F0FB]">
      <div className="min-h-screen flex flex-col-reverse max-w-[1312px] px-4 mx-auto justify-center gap-[60px] items-center py-12 xl:flex-row">
        <div className="relative max-w-[660px] md:h-[562px] h-[300px] md:overflow-hidden overflow-visible flex justify-center items-center mx-auto md:mx-0 pointer-events-none">
        ...
        <div className="grid gap-12 xl:w-fit w-full max-w-[560px]">
