    ...
    <div className='bg-[#F3F0FB] xl:h-screen h-fit flex flex-col-reverse justify-center gap-[60px] items-center py-12 xl:flex-row'>
        ...
        <div className='grid gap-12 xl:w-fit w-[90%] mx-auto xl:mx-0'>
            <div className='grid gap-6'>
                <button className=" bg-linear-to-tr from-[#97DC37] to-[#055962] rounded-[60px] py-[12px] px-[24px] font-[400] text-white text-[14px] leading-5 h-fit w-fit paytone">Coming Soon</button>
            ...
            <div className='grid gap-4'>
                <h6 className='font-[700] text-[16px] leading-6 text-black satoshi'>Stay tuned for more exciting updates!</h6>
