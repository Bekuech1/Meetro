...
const DigitalTime = ({ time, unit }) => {
  return (
    <div className="digital-font flex justify-center items-center">
      <h6 className="text-white font-normal digital-numbers text-xl">{time}</h6>
      <span className="text-[#55695E] font-normal text-sm digital-numbers capitalize ml-1">
        {unit}
      </span>
    </div>
  );
...
const EventTimerNav = ({ targetDate }) => {
  ...
  return (
    <nav className="bg-[#011F0F] w-full px-8 py-3 flex items-center gap-4 flex-shrink-0">
      <img src="/Logo.svg" alt="Logo" className="w-[30px]" />
      <div className="w-full flex justify-end gap-4 items-center">
        ...
        <div className="flex size-fit">
          ...
          <h6 className="text-white text-xl  mx-1">:</h6>
          <DigitalTime time={hour} unit="h" />
          <h6 className="text-white font-normal text-xl  mx-1">:</h6>
