...
function EventChipInModal({ chipInData, onSave }) {
  ...
  const validateChipInData = () => {
    ...
    if (
      !newChipInData.bankDetails.accountName ||
      !newChipInData.bankDetails.accountNumber ||
      !newChipInData.bankDetails.bankName ||
      !newChipInData.bankDetails.bankCode
    ) {
  ...
  return (
    <Modal.Window
      name="event-chip-in"
      title={!showBankDetails ? "Chip In" : "Add Bank"}
      onClose={resetData}
    >
      {/* Content goes here */}
        ...
        {!showBankDetails ? (
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="border self-start border-[#F9F9F9] p-[2px] bg-[#E5E7E3] rounded-full inline-flex items-center">
                <TagButton
                  ...
                  onClick={() => handleChipInTypeChange("fixed")}
                />
                <TagButton
                  text="Target Goal"
                  className={twMerge(
                  ...
                  onClick={() => handleChipInTypeChange("target")}
                />
                <TagButton
                  ...
                  onClick={() => handleChipInTypeChange("donation")}
                />
              </div>
          ...
          <div className="flex flex-col gap-y-12">
            ...
            <div className="flex items-center justify-center md:justify-start gap-x-4">
              ...
              />
              <TextButton text="Done" onClick={handleSaveBank} />
            </div>
          </div>
        )}
      </div>
