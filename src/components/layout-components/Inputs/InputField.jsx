...
export default function InputField({
  ...
  return (
    <div
      className={`flex satoshi gap-x-2 border input items-center hover:shadow-[0_4px_32px_0_rgba(0,0,0,0.06)] bg-[#f8f8f7] transition-all border-white rounded-[12px] px-[6px] py-[10px] md:py-[8px] max-h-11 md:max-h-9 backdrop-blur-xs ${className}`}
    >
      {/* Left icon */}
      {leftIcon && (
        <React.Fragment>
