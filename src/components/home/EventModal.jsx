...
const EventModal = memo(({ eventId, closeModal }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 w-full h-full lg:pt-0 pt-16 lg:h-screen lg:flex lg:items-center lg:justify-center bg-black/50 md:backdrop-blur-[4px] z-[1000] overflow-auto scrollbar-hide">
