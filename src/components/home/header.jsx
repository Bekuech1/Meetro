        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {isOpen && (
            <div className="fixed inset-0 h-screen flex items-center justify-center z-30 bg-[#00000080]/50 backdrop-blur-[4px] sm:hidden ">
              <ul className="ml-auto sm:pb-2 pb-0 px-4 bg-white rounded-l-[16px] shadow-lg w-[264px] transform transition-transform duration-300 ease-in-out satoshi z-20 h-screen">
                {/* User Info */}
