...
const NoEvents = ({ hasEvents = false, message = null }) => {
  ...
  const eventData = {
    ...
    time: "16:30pm",
    dressCode: "Lingerie",
    host: "Chubby Igboanugo",
    building: "The White House",
    location: "Yaba, Lagos, Nigeria",
    furtherDirections: "The White House is a white building with a red door. It is located next to the bank.",
    going: ["ada beauty", "chubby igboanugo", "isabel ken-uhuo", "ada beauty", "chubby igboanugo", "isabel ken-uhuo", "ada beauty", "chubby igboanugo", "isabel ken-uhuo", "ada beauty", "chubby igboanugo", "isabel ken-uhuo"],
    latitude: 6.5095,
    longitude: 3.3713,
