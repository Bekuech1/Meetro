...
const Hero = () => {
  ...
  const cards = useMemo(
    () => [
      ...
      },
      {
        ...
        customClass:
          "w-[250px] h-[292px] absolute -rotate-[30deg] invisible lg:visible",
        font: "satoshi",
      },
      {
        ...
        customClass:
          "md:w-[277px] md:h-[332px] w-[180px] h-[224px] absolute rotate-[9.9deg] z-1",
        font: "urbanist",
      },
      {
        bgImage: "/hero-ph.png",
  ...
  return (
    <div className="relative w-full min-h-screen pt-[148px] pb-[106px] flex items-center justify-center bg-[#FCFEF9] satoshi overflow-hidden">
      <div className="w-full flex gap-10 md:gap-[106px] flex-col items-center justify-center">
        <motion.section
        ...
        <div className="flex w-full px-4 flex-col items-center justify-center gap-6">
          <motion.h1
          ...
          >
            ...
            <br />
            <motion.span
              className="text-[#866AD2] will-change-transform"
              {...spanAnimation}
            >
              effortlessly.
            </motion.span>
      ...
      <div className="absolute flex justify-between items-center w-full h-fit bg-transparent -bottom-[250px]">
        <Gradient />
        <Gradient color="#866AD2" className="-mt-[100px]" />
        <Gradient color="#077D8A" />
      </div>
    </div>
  );
};
