  ...
  return (
    <div className="bg-[#03353A]">
      <div className="min-h-screen max-w-[1312px] px-4 mx-auto flex flex-col-reverse xl:flex-row justify-center gap-[60px] items-center py-12">
        <div className="max-w-[660px] w-full relative min-h-[300px] sm:min-h-[300px] md:min-h-[400px] lg:min-h-[532px] rounded-4xl bg-[linear-gradient(180deg,rgba(208,235,243,0.1)_0%,rgba(121,137,141,0.1)_100%)] backdrop-blur-[32px] flex justify-center items-center">
          <img
            src="/Rectangle.png"
            alt=""
            className="absolute lg:top-[92px] sm:top-[30px] top-[10px] z-2"
          />
          <img
            src="/Rectangle1.png"
            alt=""
            className="absolute lg:top-[132px] sm:top-[72px] top-[34px] z-1"
          />
          <img
            src="/Rectangle2.png"
            alt=""
            className="absolute lg:top-[159px] sm:top-[99px]"
          />
        </div>
        <div className="grid gap-12 xl:mx-0 max-w-[560px]">
