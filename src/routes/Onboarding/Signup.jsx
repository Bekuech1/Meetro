    ...
    const buttons= [
            {
              ...
              },
              {
                ...
                className: 'w-[343px] sm:w-[312px] h-[36px] bg-[#AFFC41] text-[#095256] px-6',
              }
    ]
  return (
    <div>
      <div>
        <Layout text={text} width={'w-[255px] sm:w-[450px]'} handleClick1="/authentication" handleClick2={()=> setShowOptions(true)}> 
